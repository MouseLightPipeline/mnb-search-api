...
The Search API service exposes a [GraphQL](https://graphql.org) interface to the denormalized neuron browser data.  It
is a read-only interface and the search database only contains the portion of the data required to present the 
interactive browser.
